...
jQuery(function($) {
    ...
    var imgZoom = function() {
        if ($.browser.msie && $.browser.version <= 9) {
            var w=$(".pc-list li img").width(),
                h=$(".pc-list li img").height();
            $(".pc-list li img").hover(function() {
               $(this).animate({'width':w*1.1,'height':h*1.1},300);

            }, function() {
               $(this).animate({'width':w,'height':h},300);
